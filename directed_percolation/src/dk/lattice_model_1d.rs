...
use crate::{Cell1D, CellModel, EvolvableLatticeDualState};
...
#[derive(Clone, Debug)]
pub struct LatticeDualState1D<C: CellModel<Cell1D>> {
...
impl<C: CellModel<Cell1D>> LatticeDualState1D<C> {
...
impl<C: CellModel<Cell1D>> EvolvableLatticeDualState<Cell1D> for LatticeDualState1D<C> {
